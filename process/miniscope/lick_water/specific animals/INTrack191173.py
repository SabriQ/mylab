...
#%% info
mouse_id = "191173"
ms_mat_path = r"Z:\XuChun\Lab Projects\01_Intra Hippocampus\Miniscope_Linear_Track\Results_191173\20191110_160946_20191028-1102all\191173_post_processed.mat"
ms_ts_pkl_path = os.path.join(os.path.dirname(ms_mat_path),'ms_ts.pkl')
result_path = os.path.join(os.path.dirname(ms_mat_path),'191173_in_track.pkl')
...
#%% Save <result>    
savemat(r"Z:\XuChun\Lab Projects\01_Intra Hippocampus\Miniscope_Linear_Track\LinearTrackAll\191173_in_track.mat",result)