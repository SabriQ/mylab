...
// contexts set-up
String context_setup = "ABCD"; // contexts corresponding to ports 1,2,3,4
int A_loc = context_setup.indexOf('A') +1;
int B_loc = context_setup.indexOf('B') +1;
int C_loc = context_setup.indexOf('C') +1;
int D_loc = context_setup.indexOf('D') +1;
...
//          }else{ Serial.print(" Stat0: wrong_choice "); Serial.println(nose_poke_time);break;}
        }else if (current_choice==A_loc && last_choice==D_loc){ //D->A
          Signal(current_choice+48);Serial.print(" Stat1: port_");Serial.print(current_choice);Serial.print(" ");
        }else if(current_choice==B_loc && last_choice==A_loc){ //A->B
          Signal(current_choice+48);Serial.print(" Stat1: port_");Serial.print(current_choice);Serial.print(" ");
        }else if(current_choice==C_loc && last_choice==B_loc){ //B->C
          Signal(current_choice+48);Serial.print(" Stat1: port_");Serial.print(current_choice);Serial.print(" ");
        }else if(current_choice==D_loc && last_choice==C_loc){ //C->D
          Signal(current_choice+48);Serial.print(" Stat1: port_");Serial.print(current_choice);Serial.print(" ");
        }else{
...
void Signal(int s){
  ...
  {
    case 49:
      water_deliver(pump_1,50);
      break;      
    case 50:
      water_deliver(pump_2,50);
      break;      
    case 51:
//      Serial.println("pump3");
      water_deliver(pump_3,50);
      break;      
    case 52:
//      Serial.println("pump4");
      water_deliver(pump_4,50);      
      break;
    default:
      break;}
    }
