...
import numpy as np
class LickWater(Exp):
    def __init__(self,port,data_dir=r"E:\linear_track",mode="lack_floor",video_record=True):
        ...
        self.mode = mode
        modes = ["adaptation_40cm","adaptation_60cm","adaptation_80cm","adaptation_80cm_CCC","local-global","elements-omission","train","test","all_blank","lack_wall","lack_floor"]
