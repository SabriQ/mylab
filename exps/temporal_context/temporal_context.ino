...
//          }else{ Serial.print(" Stat0: wrong_choice "); Serial.println(nose_poke_time);break;}
        }else if (current_choice==1 && last_choice==4){
          Signal(49);Serial.print(" Stat1: port_1 ");
        }else if(current_choice==2 && last_choice==1){
          Signal(50);Serial.print(" Stat1: port_2 ");
        }else if(current_choice==3 && last_choice==2){
...
void Signal(int s){
  ...
  {
    case 49:
      water_deliver(pump_1,10);
      break;      
    case 50:
      water_deliver(pump_2,10);
      break;      
    case 51:
//      Serial.println("pump3");
      water_deliver(pump_3,10);
      break;      
    case 52:
//      Serial.println("pump4");
      water_deliver(pump_4,10);      
      break;
    default:
      break;}
    }
...
void Read_ir(){
  ...
  if(on_signal >= 0.90){ 
      ...
      if (ir_1_value< 300 && ir_1_value>5) {ir[0] = 1;current_choice=1;}else{ir[0] = 0;} 
      if (ir_2_value< 300 && ir_2_value>5) {ir[1] = 1;current_choice=2;}else{ir[1] = 0;} 
      if (ir_3_value< 300 && ir_3_value>5) {ir[2] = 1;current_choice=3;}else{ir[2] = 0;}
      if (ir_4_value< 300 && ir_4_value>5) {ir[3] = 1;current_choice=4;}else{ir[3] = 0;}
