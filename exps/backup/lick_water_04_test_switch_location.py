...
import numpy as np
class LickWater(Exp):
    def __init__(self,port,data_dir=r"E:\linear_track",mode="test_switchlocation",video_record=True):
        ...
        self.mode = mode
        modes = ["adaptation_40cm","adaptation_100cm","train","test","local-global","test_switchlocation"]
